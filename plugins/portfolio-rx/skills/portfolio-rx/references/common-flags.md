...
**Fix:** Three honest options: (1) use real instrumented numbers with sourcing — "38% → 22% drop-off, Mixpanel Q3 2024, n=14k"; (2) use ranges with hedge — "anecdotally 5-10 fewer support tickets per week"; (3) describe what you'd have measured and why you couldn't — "shipped to internal users only, no instrumentation; planned to track adoption and time-to-first-action." Maturity beats round percentages. See: `frameworks-stream.md#prototyping-with-numbers` for the personal-project alternative.
